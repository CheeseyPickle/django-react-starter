...
- for each separate continuous region and time range, `query_executor_get_raster.py` will initialize an instance of the main remote data request driver `~/django-react-starter/backend/data_request/driver.py`
